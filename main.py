...
MENU_ICON_MAIN_MENU = "5877332341331857066"  # custom emoji id for the Main Menu / Back button
...
# Inline button custom emoji placeholders
INLINE_ICON_COPY_FORM_EMOJI_ID = "5875206779196935950"
INLINE_ICON_SUPPORT_EMOJI_ID = "5832251986635920010"
INLINE_ICON_CONFIRM_EMOJI_ID = "5951665890079544884"
INLINE_ICON_CANCEL_EMOJI_ID = "5877341274863832725"
INLINE_ICON_APPROVE_EMOJI_ID = "5931409969613116639"
INLINE_ICON_REJECT_EMOJI_ID = "5775887550262546277"
INLINE_ICON_TOTAL_ORDERS_EMOJI_ID = "5956561916573782596"
...
def build_buy_payment_keyboard(context: ContextTypes.DEFAULT_TYPE | None = None) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [
            [
                inline_button(tr(context, "USDT BEP20"), callback_data=BUY_PAY_CRYPTO),
                inline_button(tr(context, "Binance Gift Card"), callback_data=BUY_PAY_GIFTCARD),
            ]
        ]
    )
    ...
    return InlineKeyboardMarkup(
        [
            [
                inline_button(
                    "✅ Approve",
                    callback_data=f"{BUY_APPROVE_PREFIX}{order_id}",
                    icon_custom_emoji_id=INLINE_ICON_APPROVE_EMOJI_ID,
                    style=KeyboardButtonStyle.SUCCESS,
                ),
                inline_button(
                    "❌ Reject",
                    callback_data=f"{BUY_REJECT_PREFIX}{order_id}",
                    icon_custom_emoji_id=INLINE_ICON_REJECT_EMOJI_ID,
...
def nav_keyboard(context: ContextTypes.DEFAULT_TYPE | None = None) -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        [
            [KeyboardButton(text=labels[BACK_MENU_TEXT], icon_custom_emoji_id=MENU_ICON_MAIN_MENU)],
            [labels[CANCEL_TEXT]],
        ],
        resize_keyboard=True,
        one_time_keyboard=False,
        ...
        [
            [
                InlineKeyboardButton(
                    ...
                    icon_custom_emoji_id=INLINE_ICON_COPY_FORM_EMOJI_ID or None,
                )
            ]
        ]
    )
        ...
        [
            [
                InlineKeyboardButton(
                    ...
                    icon_custom_emoji_id=INLINE_ICON_CONFIRM_EMOJI_ID or None,
                    style=KeyboardButtonStyle.SUCCESS,
                ),
                InlineKeyboardButton(
                    tr(context, "Cancel"),
                    callback_data=AD_CONFIRM_NO,
                    icon_custom_emoji_id=INLINE_ICON_CANCEL_EMOJI_ID or None,
                    style=KeyboardButtonStyle.DANGER,
                ),
            ]
        ]
        ...
        [
            [
                inline_button(
                    ...
                    icon_custom_emoji_id=INLINE_ICON_SUPPORT_EMOJI_ID,
        ...
        [
            [
                ...
                inline_button(
                    ...
                    icon_custom_emoji_id=INLINE_ICON_TOTAL_ORDERS_EMOJI_ID,
                ),
            ]
        ]
    )
...
def language_inline_keyboard(context: ContextTypes.DEFAULT_TYPE | None = None) -> InlineKeyboardMarkup:
    selected_code = context.user_data.get("language_code", LANG_EN) if context is not None else LANG_EN

    def lang_btn(text: str, code: str) -> InlineKeyboardButton:
        return inline_button(
            text,
            callback_data=code,
            style=KeyboardButtonStyle.SUCCESS if code == selected_code else None,
        )

    return InlineKeyboardMarkup(
        [
            [
                lang_btn(tr(context, "Chinese 🇨🇳"), LANG_ZH),
                lang_btn(tr(context, "Hindi 🇮🇳"), LANG_HI),
            ],
            [
                lang_btn(tr(context, "Russian 🇷🇺"), LANG_RU),
                lang_btn(tr(context, "Farsi 🇮🇷"), LANG_FA),
            ],
            [
                lang_btn(tr(context, "English 🇺🇸"), LANG_EN),
                lang_btn(tr(context, "Arabic 🇸🇦"), LANG_AR),
            ],
            [
                lang_btn(tr(context, "Hebrew 🇮🇱"), LANG_HE),
                lang_btn(tr(context, "Uzbekcha 🇺🇿"), LANG_UZ),
            ],
            [
                lang_btn(tr(context, "Italiano 🇮🇹"), LANG_IT),
                lang_btn(tr(context, "Turkce 🇹🇷"), LANG_TR),
            ],
            [
                lang_btn(tr(context, "French 🇫🇷"), LANG_FR),
                lang_btn(tr(context, "Spanish 🇪🇸"), LANG_ES),
            ],
        ]
    )
...
async def language_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    context.user_data["selected_language_code"] = query.data
